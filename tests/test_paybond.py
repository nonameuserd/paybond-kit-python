...
@pytest.mark.asyncio
async def test_paybond_intents_create_accepts_adyen_manual_capture_settlement_rail() -> None:
    captured: dict[str, object] = {}
    ...
    await intents.create(
        ...
        deadline_rfc3339="2030-01-01T00:00:00Z",
        allowed_tools=["payments.capture"],
        settlement_rail="adyen_manual_capture",
        recognition_proof={},
    )
    assert captured["settlement_rail"] == "adyen_manual_capture"
